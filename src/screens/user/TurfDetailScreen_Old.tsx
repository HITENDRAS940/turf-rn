 ...
 * 
 * Features:
 * - Image gallery with scrollable carousel
...
const TurfDetailScreen = ({ route, navigation }: any) => {
  ...
  const renderImageGallery = () => {
    ...
    const handleImageScroll = (event: any) => {
      ...
      // Sync background scroll with foreground
    ...
    return (
      <Animated.View style={[styles.imageGalleryContainer, { height: headerHeight }]}>
        ...
        {/* Foreground scrollable layer with improved touch handling */}
        <View style={styles.foregroundImageContainer}>
          <Animated.ScrollView 
            ...
            scrollEventThrottle={6} // Increased frequency for smoother tracking
            decelerationRate="fast"
            bounces={false} // Disable bounce for cleaner horizontal scrolling
            scrollEnabled={images.length > 1} // Only enable scrolling if multiple images
            snapToInterval={screenWidth}
            snapToAlignment="start"
            directionalLockEnabled={true} // Lock to horizontal scrolling
          >
            {images.map((imageUri, index) => (
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <Animated.ScrollView 
        ...
        scrollEventThrottle={4} // Increased frequency for smoother animations
        bounces={true}
        bouncesZoom={false}
        showsVerticalScrollIndicator={false}
        decelerationRate="normal"
        overScrollMode="always" // Better scroll behavior on Android
      >
        {renderImageGallery()}
        ...
        <View style={[styles.content, { backgroundColor: theme.colors.background }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={[styles.priceCard, { backgroundColor: theme.colors.surface }]}>
              ...
              <Text style={[styles.price, { color: theme.colors.primary }]}>Price varies by slot</Text>
            </View>
          </View>
          ...
          <>
            <View>
              ...
              <Text style={[styles.footerPrice, { color: theme.colors.text }]}>
                {showBookingSection ? '₹0' : 'See slots for pricing'}
              </Text>
            </View>
            <Button
...
const styles = StyleSheet.create({
  ...
  foregroundImage: {
    width: '100%',
    height: 300,
    opacity: 0.1, // Very transparent for touch handling only
  },
